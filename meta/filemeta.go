...
// RenameFileMetaDB : 更新文件元信息( 重命名 )
func RenameFileMetaDB( filehash , newFilename , username string ) bool {
	return mydb.RenameFile( filehash , newFilename , username )
}

// RemoveFileMetaDB : 删除文件元信息( 删除 )
func RemoveFileMetaDB( filehash , username string ) bool {
	return mydb.RemoveFile( filehash , username )
}
